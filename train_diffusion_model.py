...
if __name__ == "__main__":
  ...
  parser.add_argument('--workdir', type=str, default='models/DM/mixed/')
  parser.add_argument('--eval_folder', type=str, default='eval')
  args = parser.parse_args()
  args.scenario_list = ['O1_28B', 'O1_28', 'I2_28B'] if args.train=='mixed' else args.scenario_list=[args.train]
  if args.train == 'O1_28':
