""" Training and evaluation of score-based generative models for MIMO channel estimation. """
  ...
  for step in range(initial_step, num_train_steps + 1):
    ...
    if step != 0 and step % config.training.snapshot_freq == 0 or step == num_train_steps:
      ...
      if config.training.snapshot_sampling:
        ...
        predictor = sampling.ReverseDiffusionPredictor  # @param ["NonePredictor", "EulerMaruyamaPredictor", "AncestralSamplingPredictor", "ReverseDiffusionPredictor"] {"type": "raw"}
        corrector = sampling.NoneCorrector  # @param ["NoneCorrector", "LangevinCorrector", "AnnealedLangevinDynamics"] {"type": "raw"}
