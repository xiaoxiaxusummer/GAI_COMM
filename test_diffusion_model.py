...
if __name__ == '__main__':
    ...
    result_dir = './results/DM/test_train-%s_test-%s' % (
    ...
    for snr_idx, channel_noise_variance in enumerate(noise_range):
        ...
        pc_conditional_sampler = get_pc_conditional_sampler(sde, shape, predictor, corrector, snr, n_steps=n_steps,
                                                            probability_flow=probability_flow,
                                                            continuous=config.training.continuous)
        x, n, nmse = pc_conditional_sampler(score_model, Y_received, Pilot_signal, channel_noise_variance, ground_truth)
